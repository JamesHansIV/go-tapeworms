...
function App() {
    ...
    return (
        <div style={{ width: `${2 * WIDTH}px`, height: '100vh', marginTop: '2em' }}>
            <div
                ...
                <ul>
                    {
                        pageArray.map((i) => {
                            return (
                                <li
                                    style={{
                                        fontSize: (currentPageNum === i) ? '18px' : '16px',
            ...
            <div className={styles.footer}>
                <a className={styles.footerLinkContainer} href={"https://draft.tapewormscynder.eeb.uconn.edu/"}>
                    <img src={gcd_logo} className={styles.footerLinkImg} />
                    <span className={styles.footerLink}>Global Cestode Database</span>
                </a>
                <a className={styles.footerLinkContainer} href={"https://tapeworms-unlocked.info/"}>
